      ...
      if(_image != null){
          if(selectedSizes.isNotEmpty){
            ...
            task.onComplete.then((snapshot1) async{
                ...
                _productService.updateProduct(widget.updateId,imageUrl,ProductNameController.text,_currentCategory,_currentBrand,int.parse(QuantityController.text),int.parse(PriceController.text),selectedSizes);
