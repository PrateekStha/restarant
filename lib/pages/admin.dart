...
import '../padmin/add_product.dart';
import 'package:restaurant/pages/showCategory.dart';
import 'package:restaurant/pages/showBrand.dart';
import 'package:restaurant/pages/showProduct.dart';
        ...
        return ListView(
          children: <Widget>[
            ...
            ListTile(
              ...
              title: Text("brand lists"),
              onTap: () {
                Navigator.push(context,MaterialPageRoute(builder: (context) => showBrand()));
              },
            ),
            Divider(),
          ],
